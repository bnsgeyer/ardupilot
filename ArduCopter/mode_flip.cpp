...
void ModeFlip::run()
{
    ...
    case FlipState::Start:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw(FLIP_ROTATION_RATE * roll_dir, FLIP_ROTATION_RATE * pitch_dir, 0.0, g2.acro_rate_rp_tc, g2.acro_rate_y_tc);
    ...
    case FlipState::Roll:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw(FLIP_ROTATION_RATE * roll_dir, 0.0, 0.0, g2.acro_rate_rp_tc, g2.acro_rate_y_tc);
        // decrease throttle
    ...
    case FlipState::Pitch_A:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw(0.0f, FLIP_ROTATION_RATE * pitch_dir, 0.0, g2.acro_rate_rp_tc, g2.acro_rate_y_tc);
        // decrease throttle
        throttle_out = MAX(throttle_out - FLIP_THR_DEC, 0.0f);
    ...
    case FlipState::Pitch_B:
        // between 45deg ~ -90deg request 400deg/sec pitch
        attitude_control->input_rate_bf_roll_pitch_yaw(0.0, FLIP_ROTATION_RATE * pitch_dir, 0.0, g2.acro_rate_rp_tc, g2.acro_rate_y_tc);
        // decrease throttle
        throttle_out = MAX(throttle_out - FLIP_THR_DEC, 0.0f);
