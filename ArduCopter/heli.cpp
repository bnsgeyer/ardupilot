...
{
    // set land complete and land complete maybe flags in motors class
    motors->set_land_complete(bool(ap.land_complete));
    motors->set_land_complete_maybe(bool(ap.land_complete_maybe));
