...
private:
    ...
    void do_arc_wp(const AP_Mission::Mission_Command& cmd);
...
private:
    ...
    Vector2p dest_A_ne_m;    // in NEU frame in cm relative to ekf origin
    Vector2p dest_B_ne_m;    // in NEU frame in cm relative to ekf origin
