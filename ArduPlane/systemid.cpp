...
void AP_SystemID::log_data() const
{
    ...
    if (is_positive(delta_angle_dt) && is_positive(delta_velocity_dt)) {
        plane.Log_Write_SysID_Data(waveform_time, waveform_sample, waveform_freq_rads / (2 * M_PI),
                                   degrees(delta_angle.x / delta_angle_dt),
                                   degrees(delta_angle.y / delta_angle_dt),
                                   degrees(delta_angle.z / delta_angle_dt),
                                   delta_velocity.x / delta_velocity_dt,
