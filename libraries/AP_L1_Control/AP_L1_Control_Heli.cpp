 ...
 */
float AP_L1_Control_Heli::get_yaw() const
{
    if (_reverse) {
 ...
 */
float AP_L1_Control_Heli::get_yaw_sensor() const
{
    if (_reverse) {
...
void AP_L1_Control_Heli::update_waypoint(const Vector2f &_origin, const Vector2f &_destination, float dist_min)
{
    ...
    Vector2f origin = _origin * 0.01;
    Vector2f destination = _destination * 0.01;
...
void AP_L1_Control_Heli::update_loiter(const Vector2f &_center_pos, float radius, int8_t loiter_direction)
{
