...
void AC_PosControl_Sub::update_xy_controller()
{
...
void AC_PosControl_Sub::relax_z_controller(float throttle_setting)
{
...
void AC_PosControl_Sub::init_z_controller()
{
...
void AC_PosControl_Sub::update_z_controller()
{
    AC_PosControl::update_z_controller();

}

void AC_PosControl_Sub::input_d_accel(const float target_z)
{
...
float AC_PosControl_Sub::get_throttle_with_vibration_override()
{
...
void AC_PosControl_Sub::standby_xyz_reset()
{
...
Vector2f AC_PosControl_Sub::get_actuator_accel_target_xy() const
{
...
float AC_PosControl_Sub::get_althold_lean_angle_max_cd() const
{
...
Vector2f AC_PosControl_Sub::lean_angles_to_accel_xy() const
{
...
void AC_PosControl_Sub::accel_to_lean_angles(float accel_x_cmss, float accel_y_cmss, float& roll_target, float& pitch_target) const
{
...
void AC_PosControl_Sub::controller_run()
{
...
void AC_PosControl_Sub::input_ned_accel_rate_heading(const Vector3f& thrust_vector, Orientation heading, const float target_z)
{
