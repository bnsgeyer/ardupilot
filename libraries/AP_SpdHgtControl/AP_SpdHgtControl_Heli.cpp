...
void AP_SpdHgtControl_Heli::init_controller(void)
{
    ...
    _pid_vel.update_all(_cmd_vel, _cmd_vel, false);
    _accel_out_last = _pid_vel.get_ff();
...
//    _vel_error = _cmd_vel - speed_forward * 100.0f;
    ...
    // call pid controller
    _pid_vel.update_all(_cmd_vel, speed_forward * 100.0f, false);
