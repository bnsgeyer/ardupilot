...
const AP_Param::GroupInfo AP_MotorsHeli_RSC::var_info[] = {
    ...
    // @Values: 1:RC Passthrough, 2:External Gov SetPoint, 3:Throttle Curve, 4:AutoThrottle, 5:Direct Drive Fixed Pitch
    // @User: Standard
...
void AP_MotorsHeli_RSC::output(RotorControlState state)
{
    ...
    case RotorControlState::ACTIVE:
        ...
        if ((_control_mode == ROTOR_CONTROL_MODE_PASSTHROUGH) || (_control_mode == ROTOR_CONTROL_MODE_SETPOINT) || (_control_mode == ROTOR_CONTROL_MODE_DDFP)) {
