...
#define AP_MOTORS_HELI_COMPOUND_EXTGYRO                          CH_7
#define AP_MOTORS_HELI_COMPOUND_TAILRSC                          CH_7
...
#define AP_MOTORS_HELI_COMPOUND_TAILTYPE_DIRECTDRIVE_FIXEDPITCH_CW  3
#define AP_MOTORS_HELI_COMPOUND_TAILTYPE_DIRECTDRIVE_FIXEDPITCH_CCW 4
#define AP_MOTORS_HELI_COMPOUND_TAILTYPE_DIRECTDRIVE_VARPIT_EXT_GOV 5


// direct-drive variable pitch defaults
#define AP_MOTORS_HELI_COMPOUND_DDVP_SPEED_DEFAULT               50
...
protected:
    ...
    const char* _get_frame_string() const override { return "HELI_COMPOUND"; }
