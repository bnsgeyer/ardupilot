...
#define AP_MOTORS_HELI_COMPOUND_SWASH_H3                         0
#define AP_MOTORS_HELI_COMPOUND_SWASH_H1                         1
#define AP_MOTORS_HELI_COMPOUND_SWASH_H3_140                     2

// collective control direction definitions
#define AP_MOTORS_HELI_COMPOUND_COLLECTIVE_DIRECTION_NORMAL      0
#define AP_MOTORS_HELI_COMPOUND_COLLECTIVE_DIRECTION_REVERSED    1
...
#define AP_MOTORS_HELI_COMPOUND_DDVP_SPEED_DEFAULT               500
